        ...
        protected void bDangNhap_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (sqlcon.State == System.Data.ConnectionState.Open)
                {
                    ...
                    //Giả sử đăng không tìm được bản ghi có mật khẩu..., tìm được thì báo OK
                    //int thanhCong = 0;
                    Session["role"] = "";
                    MD5 md5 = MD5.Create();
                    if (sqlreader.HasRows)
                    {
                        ...
                        {
                            //if(sqlreader.GetString(3) == md5.Hash(tbMatKhau.Text.Trim()))//Đăng nhập thành công
