...
namespace VD11
{
    public partial class QT1 : System.Web.UI.Page
    {
        ...
        /// Tu vi du nay, thay vi lap lai ma nguon de doc du lieu, ta dung CommonCode....
        /// </summary>
        /// <param name="pageIndex"></param>
        /// 
        private void BindDataToGridView(int pageIndex)
        {
            //Doan ma nguon nay duoc thay bang doan o duoi, co su dung thu vien CommonCode....
            /*
            ...
            try
            {
                ...
                //DataTable dt = //new DataTable();
                string sql = "SELECT ID, ten, maTheLoai FROM HangHoa ORDER BY ID DESC";//ko dung schema TP.
                //CommonCode.DataClasses.DataTool dataTool = new CommonCode.DataClasses.DataTool();
                //DataTable dt = dataTool.execSelect(conString, sql, null);
               // GridView1.DataSource = dataTool.execSelect(conString, sql, null);
                GridView1.DataSource = (new CommonCode.DataClasses.DataTool()).execSelect(conString, sql, null); 
                //dung cai nay de phan trang
                if (pageIndex >= 0)
                    GridView1.PageIndex = pageIndex;
                GridView1.DataBind();
