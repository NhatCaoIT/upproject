...
namespace VD
{
    public partial class QT1 : System.Web.UI.Page
    {
        ...
        /// </summary>
        /// <param name="pageIndex">Giá trị chỉ số thứ tự của trang dữ liệu trong gridview</param>
        /// <param name="sortExpression">Chỉ cột mà theo đó ta thực hiện sắp xếp</param>
        /// <param name="sortDirection">Chỉ chiều sắp xếp, ASC hay DESC</param>
        private void BindDataToGridView(int pageIndex, string sortExpression, string sortDirection = "ASC")
        {
            ...
            try
            {
                ...
                if (sqlSconn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    GridView1.HeaderRow.Cells[1].Text = "Tên hàng";
